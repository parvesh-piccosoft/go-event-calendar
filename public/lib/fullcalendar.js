...
var FullCalendar = function(e) {
    ...
    function Ji(e, t=!1) {
        ...
        return Zi() && "rtl" === n.direction ? c.scrollbarLeft = l : c.scrollbarRight = l,
    ...
    class ns {
        ...
        similarTo(e) {
            return rs(this.tops || [], e.tops || []) && rs(this.bottoms || [], e.bottoms || []) && rs(this.lefts || [], e.lefts || []) && rs(this.rights || [], e.rights || [])
        }
    }
    function rs(e, t) {
        const n = e.length;
    ...
    class ls {
        ...
        insertEntryAt(e, t) {
            ...
            -1 === t.lateral ? (fs(r, t.level, t.levelCoord),
            fs(n, t.level, [e])) : fs(n[t.level], t.lateral, e),
        ...
        findInsertion(e) {
            ...
            for (let u = 0; u < s; u += 1) {
                ...
                if (!r && s >= o + e.thickness)
                    break;
                let h, f = n[u], g = gs(f, e.span.start, cs), p = g[0] + g[1];
            ...
            if (c)
                for (u = a + 1; u < s && t[u] < o; )
                    u += 1;
            let h = -1;
            return u < s && t[u] === o && (h = gs(n[u], e.span.end, cs)[0]),
            {
                touchingLevel: a,
                touchingLateral: l,
                touchingEntry: c,
    ...
    class Ms {
        ...
        _sliceBusinessHours(e, t, n, r, ...i) {
            return e ? this._sliceEventStore(mr(e, Is(t, Boolean(n)), r), {}, t, n, ...i).bg : []
        }
    ...
    function js(e, t, n, r, i) {
        return "businessHours" === e ? zs(mr(r, t, i)) : "string" == typeof e ? zs(kr(n, t=>t.groupId === e)) : "object" == typeof e && e ? zs(mr(e, t, i)) : []
    }
    function zs(e) {
        let {instances: t} = e
          , n = [];
    ...
    class Ls extends Gn {
        ...
        needsXScrolling() {
            if (Ws.test(this.props.overflowX))
                return !1;
            let {el: e} = this
        ...
        needsYScrolling() {
            if (Ws.test(this.props.overflowY))
                return !1;
            let {el: e} = this
    ...
    function oo(e) {
        // console.log("e= ",e.event._instance.range.start)
        var todayDate = new Date(e.event._instance.range.start).toISOString().slice(0, 10);
        return p("div", {
            className: "fc-event-main-frame"
        }, e.timeText && p("div", {
            className: "fc-event-time"
        }, e.timeText), p("a", {
            href: "/datelist?date="+todayDate,
            className: "fc-event-title-container"
        }, p("div", {
            className: "fc-event-title fc-sticky"
        }, e.event.title || p(y, null, " "))))
    }
    const ao = e=>p(Ln.Consumer, null, t=>{
        let {options: n} = t
          , r = {
            isAxis: e.isAxis,
    ...
    const mo = e=>p(Ln.Consumer, null, t=>{
    ...
    function Vo(e, t, n, r) {
        ...
        case "FETCH_EVENT_SOURCES":
            return Yo(e, t.sourceIds ? An(t.sourceIds) : Xo(e, r), i, t.isRefetch || !1, r);
        case "RECEIVE_EVENTS":
        ...
        constructor() {
            ...
            this.registerInteractiveComponent = (e,t)=>{
                let n = function(e, t) {
                  ...
                  , r = [wa, Ca].concat(this.props.pluginHooks.componentInteractions).map(e=>new e(n));
    ...
    class Oa {
        constructor(e) {
            ...
            Ma += 1,
            1 === Ma && window.addEventListener("touchmove", Na, {
                passive: !1
            })
        }
        destroy() {
            ...
            Ma -= 1,
            Ma || window.removeEventListener("touchmove", Na, {
                passive: !1
            })
        }
        tryStart(e) {
    ...
    class Ua {
        ...
        buildCaches(e) {
            return this.queryScrollEls(e).map(e=>e === window ? new ja(!1) : new Ba(e,!1))
        }
        queryScrollEls(e) {
            let t = [];
    ...
    class La {
        ...
        isWithinClipping(e, t) {
            ...
            for (let e of this.scrollCaches)
                if (!Fa(e.getEventTarget()) && !Ni(n, e.clientRect))
                    return !1;
            return !0
        }
    }
    ...
    class Va {
        ...
        processFirstCoord(e) {
            ...
            i instanceof HTMLElement && (t = es(i),
            r = Hi(r, t));
        ...
        handleMove(e, t) {
            ...
            !t && Ga(this.movingHit, n) || (this.movingHit = n,
    ...
    class Xa {
        ...
        buildDragMeta(e) {
            return "object" == typeof this.suppliedDragMeta ? ys(this.suppliedDragMeta) : "function" == typeof this.suppliedDragMeta ? ys(this.suppliedDragMeta(e)) : function(e) {
                let t = function(e, t) {
                    let n = ms.dataAttrPrefix
                      , r = (n ? n + "-" : "") + t;
                    return e.getAttribute("data-" + r) || ""
                }(e, "event");
                return ys(t ? JSON.parse(t) : {
                    create: !1
                })
            }(e)
        }
            ...
            return p(Eo, {
                ...
                popoverContent: ()=>{
                    ...
                    return p(y, null, t.map(t=>{
                        ...
                        }, pi(t, e.todayRange))) : p(sl, Object.assign({
                            seg: t,
                            isDragging: !1,
                            isResizing: !1,
                            isDateSelecting: !1,
    ...
    class ml extends as {
        ...
        render() {
            let {props: e, state: t, context: n} = this
              ...
              , {singleColPlacements: c, multiColPlacements: d, moreCnts: u, moreMarginTops: h} = fl(ci(e.fgEventSegs, r.eventOrder), e.dayMaxEvents, e.dayMaxEventRows, r.eventOrderStrict, t.eventInstanceHeights, t.maxContentHeight, e.cells)
    ...
    class vl extends as {
        ...
        prepareHits() {
            this.rowPositions = new ns(this.rootEl,this.rowRefs.collect().map(e=>e.getCellEls()[0]),!1,!0),
            this.colPositions = new ns(this.rootEl,this.rowRefs.currentMap[0].getCellEls(),!0,!1)
        }
        queryHit(e, t) {
    ...
    function _l(e) {
        ...
        return p(Ln.Consumer, null, n=>{
            ...
            let {dateEnv: r, options: i, viewApi: s} = n
              , o = null == i.slotLabelFormat ? xl : Array.isArray(i.slotLabelFormat) ? an(i.slotLabelFormat[0]) : an(i.slotLabelFormat)
              , a = {
                level: 0,
                time: e.time,
        ...
        renderHScrollLayout(e, t, n, r, i, s, o) {
            ...
            return h.push({
                ...
                chunks: [{
                    ...
                    }, e.tableColGroupNode, p("tbody", null, p(kl, {
                        slatMetas: s
                    }))), p("div", {
    ...
    class Pl extends Gn {
        render() {
            ...
            return p("tbody", null, e.slatMetas.map((i,s)=>{
                ...
                }, e.axis && p(_l, Object.assign({}, i)), p(Jn, {
                    elTag: "td",
    ...
    class Hl extends Gn {
        ...
        updateSizing() {
            ...
            if (t.onCoords && null !== t.clientWidth) {
                this.rootElRef.current.offsetHeight && t.onCoords(new Nl(new ns(this.rootElRef.current,(n = this.slatElRefs.currentMap,
              ...
              , n = Gl((e,t)=>e + ":" + t, (r,i)=>{
                let s = Ll(function(e, t, n) {
                    ...
                    for (; l < a && r[l] < o; l += 1)
                        ;
                    for (; l < a; l += 1) {
                        let e, t = i[l], n = gs(t, s.span.start, cs), r = n[0] + n[1], o = r;
    ...
    class Zl extends Gn {
        ...
        renderFillSegs(e, t) {
            let {props: n, context: r} = this
              , i = Ql(e, n.date, n.slatCoords, r.options.eventMinHeight).map((r,i)=>{
                let s = e[i];
                return p("div", {
                    key: vi(s.eventRange),
    ...
    function Xl(e, {todayRange: t, nowDate: n, eventSelection: r, eventDrag: i, eventResize: s}) {
    ...
    class Jl extends Gn {
        ...
        updateCoords() {
            let {props: e} = this;
            var t;
            e.onColCoords && null !== e.clientWidth && e.onColCoords(new ns(this.rootElRef.current,(t = this.cellElRefs.currentMap,
                ...
                component: class extends Il {
                    ...
                    render() {
                        let {options: e, dateEnv: t, dateProfileGenerator: n} = this.context
                          ...
                          , f = t=>p(nc, Object.assign({}, o.timed, {
                            dayTableModel: s,
                            dateProfile: i,
                            axis: c,
                            slotDuration: e.slotDuration,
    ...
    function Dc(e, t) {
        return e || (t[0].currentRange.start.getUTCFullYear() !== t[t.length - 1].currentRange.start.getUTCFullYear() ? Ec : Sc)
    }
    const Ac = {
